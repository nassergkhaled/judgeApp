...
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
 ...
 session_start();
    ...
    $sql ="Select * from project WHERE code ='$mycode'";
...
<div class="main-block">
  <?php
   $_SESSION['role'] = "1";
   $userid=$row['j1id'];
   $sql3 ="SELECT `username` FROM `users` WHERE `userid`='$userid' ";
  ...
  <br> -قابل للاختبار باستخدام الاساليب العلمية <p></td>
   ...
   <td style="width:100 "> <input style="width:100% " type="text" name="j<?php echo $_SESSION['role'];?>m1"   value=<?php echo  $row[$jm1];  ?>  > </td>
  </tr>
