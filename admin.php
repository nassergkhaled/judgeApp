...
<div class="main-block">
    ...
    <form  method="post">
       ...
       <label>رقم المشروع</label><input style="width=100" type="text" name="code" id="code" >
...
<script>
        ...
        if (event.keyCode == 13) {
			...
			window.location="admin_retrivee.php?code="+document.getElementById('code').value+"&username=";
        return true;
        }
    });
